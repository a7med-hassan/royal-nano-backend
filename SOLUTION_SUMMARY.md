...
- **Database**: royalNano
- **Username**: admin
- **Connection String**: مُعد مسبقاً في الكود

**ملاحظة مهمة**: تم حل مشكلة كلمة المرور التي تحتوي على رموز خاصة:
...
- Database: royalNano
- Username: admin
- Connection String: يعمل مع كلمة المرور المُشفرة
...
**ملاحظة**: استخدم كلمة المرور المُشفرة (`%24` بدلاً من `$`، `%23` بدلاً من `#`)
...
✅ **تم حل مشكلة كلمة المرور مع الرموز الخاصة**
...
**المشكلة**: كلمة المرور `royalnano$12#` تحتوي على رموز خاصة
**الحل**: تم تشفير الرموز الخاصة:
